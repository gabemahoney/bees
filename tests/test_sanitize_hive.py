...
class TestSanitizeHive:
    ...
    def test_sanitize_unregistered_hive_returns_error(self, tmp_path, monkeypatch):
        ...
        result = _sanitize_hive("nonexistent")
        
        assert result["status"] == "error"
        assert result["error_type"] == "hive_not_found"
        assert "not registered" in result["message"]
    
    def test_sanitize_returns_detailed_report(self, tmp_path, monkeypatch):
    ...
    def test_sanitize_detects_invalid_hive_prefix(self, tmp_path, monkeypatch):
...
""")
    ...
    def test_sanitize_detects_cross_hive_violations(self, tmp_path, monkeypatch):
    ...
    def test_sanitize_marks_corrupt_on_unfixable_errors(self, tmp_path, monkeypatch):
...
""")
    ...
    def test_sanitize_fixes_orphaned_relationships(self, tmp_path, monkeypatch):
