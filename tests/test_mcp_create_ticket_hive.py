...
class TestMCPCreateTicketWithHive:
    """Tests for await _create_ticket() MCP tool with hive_name parameter."""

    async def test_create_epic_with_hive(self, temp_tickets_dir):
    ...
    async def test_create_task_with_hive(self, temp_tickets_dir):
    ...
    async def test_hive_name_normalization(self, temp_tickets_dir):
    ...
    async def test_hive_with_all_ticket_types(self, temp_tickets_dir):
    ...
    async def test_hive_with_dependencies(self, temp_tickets_dir):
...
class TestMCPCreateTicketHiveValidation:
    """Tests for await _create_ticket() hive_name validation."""

    async def test_valid_hive_names_pass(self, temp_tickets_dir):
        """Valid hive names should pass validation."""
        # Simple alphanumeric
        result1 = await _create_ticket(
            ticket_type="epic",
            title="Test 1",
            hive_name="backend"
        )
    ...
    async def test_special_chars_only_hive_name_raises_error(self, temp_tickets_dir):
    ...
    async def test_normalized_empty_string_raises_error(self, temp_tickets_dir):
    ...
    async def test_hive_with_special_chars_passes(self, temp_tickets_dir):
    ...
    async def test_hive_with_only_special_chars_fails(self, temp_tickets_dir):
    ...
    async def test_hive_with_mixed_alphanumeric_special_passes(self, temp_tickets_dir):
    ...
    async def test_normalized_result_never_empty_when_alphanumeric_present(self, temp_tickets_dir):
...
class TestMCPCreateTicketRequiredHive:
    """Tests for await _create_ticket() with required hive_name parameter (Task bees-0pe2j)."""
    ...
    async def test_create_ticket_with_none_hive_raises_error(self, temp_tickets_dir):
    ...
    async def test_create_ticket_with_empty_string_raises_error(self, temp_tickets_dir):
    ...
    async def test_create_ticket_with_whitespace_raises_error(self, temp_tickets_dir):
    ...
    async def test_create_ticket_with_valid_hive_succeeds(self, temp_tickets_dir):
    ...
    async def test_all_ticket_types_require_hive(self, temp_tickets_dir):
    ...
    async def test_error_messages_are_clear(self, temp_tickets_dir):
