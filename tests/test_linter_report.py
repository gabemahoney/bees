...
class TestValidationError:
    ...
    def test_create_validation_error(self):
        ...
        assert error.ticket_id == "default.bees-abc"
...
class TestLinterReport:
    ...
    def test_add_error(self):
        ...
        assert report.errors[0].ticket_id == "default.bees-abc"
        assert report.errors[0].error_type == "id_format"

    def test_add_multiple_errors(self):
        """Should add multiple errors."""
        report = LinterReport()
        report.add_error("default.bees-abc", "id_format", "Error 1")
        report.add_error("default.bees-xyz", "duplicate_id", "Error 2")
    ...
    def test_get_errors_filter_by_ticket_id(self):
        ...
        report.add_error("default.bees-abc", "id_format", "Error 1")
        report.add_error("default.bees-xyz", "duplicate_id", "Error 2")
        report.add_error("default.bees-abc", "missing_parent", "Error 3")

        errors = report.get_errors(ticket_id="default.bees-abc")

        assert len(errors) == 2
        assert all(e.ticket_id == "default.bees-abc" for e in errors)

    def test_get_errors_filter_by_error_type(self):
        """Should filter errors by error type."""
        report = LinterReport()
        report.add_error("default.bees-abc", "id_format", "Error 1")
        report.add_error("default.bees-xyz", "id_format", "Error 2")
        report.add_error("default.bees-abc", "duplicate_id", "Error 3")
    ...
    def test_get_errors_filter_by_severity(self):
        ...
        report = LinterReport()
        report.add_error("default.bees-abc", "id_format", "Error", severity="error")
        report.add_error("default.bees-xyz", "minor", "Warning", severity="warning")
        report.add_error("default.bees-123", "bad_id", "Error", severity="error")
    ...
    def test_get_errors_multiple_filters(self):
        ...
        report = LinterReport()
        report.add_error("default.bees-abc", "id_format", "Error", severity="error")
        report.add_error("default.bees-abc", "id_format", "Warning", severity="warning")
        report.add_error("default.bees-xyz", "id_format", "Error", severity="error")

        errors = report.get_errors(ticket_id="default.bees-abc", severity="error")
    ...
    def test_is_corrupt_with_only_warnings(self):
        ...
        report = LinterReport()
        report.add_error("default.bees-abc", "minor", "Warning", severity="warning")
    ...
    def test_to_dict(self):
        ...
        report = LinterReport()
        report.add_error("default.bees-abc", "id_format", "Error 1", severity="error")
        report.add_error("default.bees-xyz", "minor", "Warning 1", severity="warning")
    ...
    def test_to_json(self):
        ...
        report = LinterReport()
        report.add_error("default.bees-abc", "id_format", "Error")
    ...
    def test_get_summary(self):
        ...
        report = LinterReport()
        report.add_error("default.bees-abc", "id_format", "Error 1", severity="error")
        report.add_error("default.bees-xyz", "id_format", "Error 2", severity="error")
        report.add_error("default.bees-123", "duplicate_id", "Error 3", severity="error")
        report.add_error("default.bees-abc", "minor", "Warning", severity="warning")
    ...
    def test_to_markdown_with_errors(self):
        ...
        report = LinterReport()
        report.add_error("default.bees-abc", "id_format", "Invalid format", severity="error")
        report.add_error("default.bees-xyz", "id_format", "Invalid format", severity="error")
        report.add_error("default.bees-123", "duplicate_id", "Duplicate", severity="error")
        ...
        assert "default.bees-abc" in markdown
        assert "default.bees-xyz" in markdown
        assert "default.bees-123" in markdown

    def test_to_markdown_with_warnings(self):
        """Should handle warnings in markdown output."""
        report = LinterReport()
        report.add_error("default.bees-abc", "minor", "Minor issue", severity="warning")
