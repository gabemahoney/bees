...
```bash
bees create-ticket --ticket-type bee --title "Bug fix" --hive backend
bees create-ticket --ticket-type bee --title "Long writeup" --hive backend --body "stub - see appended chunks"
