---
id: features.bees-ab6
type: subtask
title: Update mcp_hive_ops.py entry points
description: |
  Context: Wrap all entry points in mcp_hive_ops.py with repo_root_context and remove downstream repo_root params.

  What to Change:
  - Import repo_root_context from repo_context
  - Import resolve_repo_root from mcp_repo_utils
  - For each MCP tool function (_colonize_hive, _list_hives, _abandon_hive, _rename_hive, _sanitize_hive):
...
status: completed
created_at: '2026-02-04T19:15:05.000000'
updated_at: '2026-02-04T19:15:05.000000'
bees_version: '1.1'
---
